...
public class BackdoorController {
    ...
    private void createImages() {
        ...
        jdbcTemplate.update("""
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000IMG0001", "0BV000PRO0001", "https://ahastudio.github.io/my-image-assets/images/cbcl-products/01",
                now, now
        );
        jdbcTemplate.update("""
                        INSERT INTO images (
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000IMG0002", "0BV000PRO0002", "https://ahastudio.github.io/my-image-assets/images/cbcl-products/02",
                now, now
        );
    }
    ...
    private void createProductOptionItems() {
        ...
        jdbcTemplate.update("""
                        INSERT INTO products_option_items (
                            id, product_id, name, created_at, updated_at)
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000ITEM0001", "0BV000OPT0001", "Black",
                now, now
        );
        jdbcTemplate.update("""
                        INSERT INTO products_option_items (
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000ITEM0002", "0BV000OPT0001", "White",
                now, now
        );
        jdbcTemplate.update("""
                        INSERT INTO products_option_items (
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000ITEM0003", "0BV000OPT0002", "M",
                now, now
        );
        jdbcTemplate.update("""
                        INSERT INTO products_option_items (
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000ITEM0004", "0BV000OPT0002", "L",
                now, now
        );
    }
    ...
    private void createProductOptions() {
        ...
        jdbcTemplate.update("""
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000OPT0001", "0BV000PRO0001", "색상",
                now, now
        );
        jdbcTemplate.update("""
                        INSERT INTO products_options (
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000OPT0002", "0BV000PRO0001", "사이즈",
                now, now
        );
    }
        ...
        jdbcTemplate.update(
                """
                        INSERT INTO order_options (
                            ...
                            product_option_id, name,
                                                product_option_item_id,
                            product_option_item_name,
                            created_at, updated_at)
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                        """,
                "0BV000OOP0002", "0BV000OLI0001",
                "0BV000OPT0002", "사이즈",
                "0BV000ITEM005", "L",
                now, now
        );
